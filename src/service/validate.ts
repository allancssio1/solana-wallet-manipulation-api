...
// import { githubToken, privateKey } from '../env'

// // Configurações iniciais
// const MINT_ADDRESS: string = new Uint8Array(privateKey) // Substitua pelo endereço da mint do token
// const WALLET_PATH: string = '~/.config/solana/devnet.json' // Caminho da chave privada
// const GITHUB_TOKEN: string = githubToken // Token de acesso pessoal do GitHub
